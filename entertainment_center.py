...
lotr1 = media.Movie("The Lord of the Rings: The Fellowship of the Ring",
    "200 min",
    "10/10",
    "First part of the Lord of the Rings trilogy. From the shire to the breaking ot the fellowship",
...
lotr2 = media.Movie("The Lord of the Rings: The Two Towers",
    "200 min",
    "10/10",
    "Second part of the Lord of the Rings trilogy. The fellowship is broken and each part follows a different"
    + "path. Tells of the further journey of the ring, the war between Rohan and Isengard and (spoiler alert)"
...
lotr3 = media.Movie("The Lord of the Rings: The Return of the King",
    "200 min",
    "10/10",
    "Third part of the Lord of the Rings trilogy. Tells of the final battles between good and evil and follows"
...
bb_1_1 = media.TvShow("Breaking Bad",
    "55 min",
    "10/10",
    1,
    1,
...
bb_1_2 = media.TvShow("Breaking Bad",
    "55 min",
    "9.8/10",
    1,
    2,
...
got_1_1 = media.TvShow("Game Of Thrones",
    "45 min",
    "9.5/10",
    1,
    1,
